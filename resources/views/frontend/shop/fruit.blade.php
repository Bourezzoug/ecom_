                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="swiper-slide">
                        <div class="flex flex-col items-center space-y-3 relative overflow-hidden">
                            ...
                            @endif
                            <form action="{{ Route('cart.store',['id'  =>  $fruit->id]) }}" method="POST" class="flex items-center space-x-5 cart-insert">
                                @csrf
                                {{-- <div id="quantity-element" class="mt-10 items-center">
                                  <div class="flex items-center space-x-4">
                                      ...
                                      <div class="flex items-center gap-1">
                                          <button
                                              type="button"
                                              onclick="updateQuantity({{ $fruit->typeQuantity == 'Unité' ? 1 : -0.5}})"
