...
@section('content')
    ...
    <section id="about" >
        ...
        <div class="container mx-auto p-6 grid grid-cols-2 gap-5 mt-10">
            <div>
                <div class="mt-16">
            ...
            <div class="overflow-hidden h-[410px]">
                <img src="https://vegvi-store-newdemo.myshopify.com/cdn/shop/files/6_140a1b51-3ade-43f2-afff-172a74ba1af2.jpg?v=1721445170" class="hover:scale-110 transition-all duration-500 h-full object-cover" alt="">
            </div>
        </div>
        <div class="container mx-auto p-6 grid grid-cols-2 gap-5 mt-6 mb-10">
            <div class="overflow-hidden h-[410px]">
        ...
        <div class="container mx-auto p-6 mt-10">
            ...
            <div class="grid grid-cols-3 gap-5 mt-6">
                <div>
                    <div class="h-[385px] bg-cover bg-center relative flex items-center justify-center" style="background-image: url('https://vegvi-store-newdemo.myshopify.com/cdn/shop/files/people4.webp?v=1721450104')">
                        <div class="hidden">
                ...
                <div>
                    <div class="h-[385px] bg-cover bg-center relative flex items-center justify-center" style="background-image: url('//vegvi-store-newdemo.myshopify.com/cdn/shop/files/people2.webp?v=1721450133')">
                        <div class="hidden">
                            <div class="absolute top-0 left-0 w-full h-full bg-black bg-opacity-50"></div>
                            <div class="flex items-center space-x-3">
                                <div class="w-10 h-10 flex items-center justify-center bg-white rounded z-50">
                ...
                <div>
                    <div class="h-[385px] bg-cover bg-center relative flex items-center justify-center" style="background-image: url('//vegvi-store-newdemo.myshopify.com/cdn/shop/files/ceo1.jpg?v=1721451073')">
                        <div class="hidden">
                            <div class="absolute top-0 left-0 w-full h-full bg-black bg-opacity-50"></div>
                            <div class="flex items-center space-x-3">
                                <div class="w-10 h-10 flex items-center justify-center bg-white rounded z-50">
