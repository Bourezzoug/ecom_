<footer>
    <div class="flex">
        <div class="border-t border-r border-b px-12 py-16 w-[40%]">
            ...
            <form action="" class="mt-8">
                <div class="flex items-center space-x-2">
                    <input type="text" class="text-sm border-gray-300 rounded-xl py-3 w-80" placeholder="Your email address">
                    <button class="bg-black text-white px-8 py-4 shadow rounded-xl text-xs tracking-wider font-medium">
                        SUBSCRIBE
                    </button>
                </div>
            </form>
        </div>
        <div class="border-t border-r border-b w-[30%] py-16 flex flex-col items-center">
        ...
        <div class="border-t border-b grid grid-rows-2 py-16 w-[40%]">
