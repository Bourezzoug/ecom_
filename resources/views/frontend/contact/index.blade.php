          ...
          <div class="-mx-4 flex flex-wrap lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                <span class="text-main-color mb-4 block text-base font-semibold">
                  - Contactez-nous
                </span>
                <h2
                  class="text-black mb-6 text-[32px] tracking-[0.20em] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                >
                PRENEZ CONTACT <br> AVEC NOUS
                </h2>
                <p class="text-body-color mb-9 text-base leading-relaxed">
                  Merci de votre intérêt pour nous contacter ! Nous apprécions vos commentaires et sommes là pour répondre à toutes les questions que vous pourriez avoir. Veuillez remplir le formulaire et nous vous répondrons dès que possible.
                </p>
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div
                    class="  mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                  >
                    <svg
                      width="24"
                      height="26"
                  ...
                  <div class="w-full">
                    <h4 class="text-black mb-1 text-xl font-bold">Téléphone</h4>
                    <p class="text-body-color text-base">+212 000 000 000</p>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div
                  ...
                  <div class="w-full">
                    <h4 class="text-black mb-1 text-xl font-bold">Email</h4>
                    <p class="text-body-color text-base">hello@domain.com</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div class="relative rounded-lg bg-white p-8 shadow-2xl sm:p-12">
                <form action="{{ Route('contact.store') }}" method="POST" id="contactForm">
                  ...
                  <div class="mb-6">
                    <input
                      ...
                      class="outline-none shadow-none text-body-color border-[f0f0f0]  w-full rounded border py-3 px-[14px] text-base"
                    />
                  </div>
                  <div class="mb-6">
                    <input
                ...
                <div>
                  <span class="absolute -top-10 -right-1 z-[-1]">
                    <svg
                      width="100"
                      height="100"
                      viewBox="0 0 100 100"
